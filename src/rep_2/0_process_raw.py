...
def plot_fluo_over_time(d, interval_mins, output_folder, palette, Exp_num, length_exp, types=['change_in_intensity'], ylim=False, savefig=True):
    ...
    for t1, xyz in test_Df[test_Df['type'].isin(types)].groupby(['t1']):
        ...
        for i, (t2, abc) in enumerate(xyz.groupby('t2')):
            ...
            t2
            abc
            sns.lineplot(data=abc, x='time (h)', y='intensity', palette=palette, hue='t3', ax=axes[i])
...
col_name_dict = {
 ...
 'C03':'control_TDPLCD-monomer_1',
 'C04':'control_TDPLCD-monomer_1',
 'C05':'control_TDPLCD-monomer_1',
 ...
 'O07':'control_TDPLCD-monmon_1',
 'O08':'control_TDPLCD-monmon_1',
 'O09':'control_TDPLCD-monmon_1',
