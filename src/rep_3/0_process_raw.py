...
def read_add_time(input_folder, filename, interval_mins):
    ...
    #drop the weird 'sampleX stuff the plate reader gives
    df.drop(df.index[:1], inplace=True)
    #in this one case, we need to remove the first few rows(can do this manually lol)
...
col_name_dict = {
    'B03':'blank_blank-x-x-x_1',
 'B04':'blank_blank-x-x-x_1',
 'B05':'blank_blank-x-x-x_1',
 'B07':'blank_blank-x-x-x_2',
 'B08':'blank_blank-x-x-x_2',
 'B09':'blank_blank-x-x-x_2',
 'B11':'control_TDPt35-unsonicated-seeds_1',
 'B12':'control_TDPt35-unsonicated-seeds_1',
 'B13':'control_TDPt35-unsonicated-seeds_1',
 'B15':'seeding_TDPmRUBY-sonicated-0.3_1',
 'B16':'seeding_TDPmRUBY-sonicated-0.3_1',
 'B17':'seeding_TDPmRUBY-sonicated-0.3_1',
 'C03':'control_TDPLCD-monomer-0_1',
 'C04':'control_TDPLCD-monomer-0_1',
 'C05':'control_TDPLCD-monomer-0_1',
 'C07':'control_TDPt25-unsonicated-seeds_1',
 'C08':'control_TDPt25-unsonicated-seeds_1',
 'C09':'control_TDPt25-unsonicated-seeds_1',
 'C11':'seeding_TDPt35-unsonicated-1_1',
 'C12':'seeding_TDPt35-unsonicated-1_1',
 'C13':'seeding_TDPt35-unsonicated-1_1',
 'C15':'seeding_TDPmRUBY-sonicated-0.3_1',
 'C16':'seeding_TDPmRUBY-sonicated-0.3_1',
 'C17':'seeding_TDPmRUBY-sonicated-0.3_1',
 'D03':'control_TDPLCD-unsonicated-seeds_1',
 'D04':'control_TDPLCD-unsonicated-seeds_1',
 'D05':'control_TDPLCD-unsonicated-seeds_1',
 'D07':'seeding_TDPt25-unsonicated-1_1',
 'D08':'seeding_TDPt25-unsonicated-1_1',
 'D09':'seeding_TDPt25-unsonicated-1_1',
 'D11':'seeding_TDPt35-unsonicated-0.3_1',
 'D12':'seeding_TDPt35-unsonicated-0.3_1',
 'D13':'seeding_TDPt35-unsonicated-0.3_1',
 'D15':'seeding_TDPmRUBY-sonicated-0.1_1',
 'D16':'seeding_TDPmRUBY-sonicated-0.1_1',
 'D17':'seeding_TDPmRUBY-sonicated-0.1_1',
 'E03':'seeding_TDPLCD-unsonicated-1_1',
 'E04':'seeding_TDPLCD-unsonicated-1_1',
 'E05':'seeding_TDPLCD-unsonicated-1_1',
 'E07':'seeding_TDPt25-unsonicated-0.3_1',
 'E08':'seeding_TDPt25-unsonicated-0.3_1',
 'E09':'seeding_TDPt25-unsonicated-0.3_1',
 'E11':'seeding_TDPt35-unsonicated-0.1_1',
 'E12':'seeding_TDPt35-unsonicated-0.1_1',
 'E13':'seeding_TDPt35-unsonicated-0.1_1',
 'E15':'seeding_TDPmRUBY-sonicated-0.03_1',
 'E16':'seeding_TDPmRUBY-sonicated-0.03_1',
 'E17':'seeding_TDPmRUBY-sonicated-0.03_1',
 'F03':'seeding_TDPLCD-unsonicated-0.3_1',
 'F04':'seeding_TDPLCD-unsonicated-0.3_1',
 'F05':'seeding_TDPLCD-unsonicated-0.3_1',
 'F07':'seeding_TDPt25-unsonicated-0.1_1',
 'F08':'seeding_TDPt25-unsonicated-0.1_1',
 'F09':'seeding_TDPt25-unsonicated-0.1_1',
 'F11':'seeding_TDPt35-unsonicated-0.03_1',
 'F12':'seeding_TDPt35-unsonicated-0.03_1',
 'F13':'seeding_TDPt35-unsonicated-0.03_1',
 'F15':'seeding_TDPmRUBY-sonicated-0.01_1',
 'F16':'seeding_TDPmRUBY-sonicated-0.01_1',
 'F17':'seeding_TDPmRUBY-sonicated-0.01_1',
 'G03':'seeding_TDPLCD-unsonicated-0.1_1',
 'G04':'seeding_TDPLCD-unsonicated-0.1_1',
 'G05':'seeding_TDPLCD-unsonicated-0.1_1',
 'G07':'seeding_TDPt25-unsonicated-0.03_1',
 'G08':'seeding_TDPt25-unsonicated-0.03_1',
 'G09':'seeding_TDPt25-unsonicated-0.03_1',
 'G11':'seeding_TDPt35-unsonicated-0.01_1',
 'G12':'seeding_TDPt35-unsonicated-0.01_1',
 'G13':'seeding_TDPt35-unsonicated-0.01_1',
 'H03':'seeding_TDPLCD-unsonicated-0.03_1',
 'H04':'seeding_TDPLCD-unsonicated-0.03_1',
 'H05':'seeding_TDPLCD-unsonicated-0.03_1',
 'H07':'seeding_TDPt25-unsonicated-0.01_1',
 'H08':'seeding_TDPt25-unsonicated-0.01_1',
 'H09':'seeding_TDPt25-unsonicated-0.01_1',
 'H11':'control_TDPt35-sonicated-seeds_1',
 'H12':'control_TDPt35-sonicated-seeds_1',
 'H13':'control_TDPt35-sonicated-seeds_1',
 'I03':'seeding_TDPLCD-unsonicated-0.01_1',
 'I04':'seeding_TDPLCD-unsonicated-0.01_1',
 'I05':'seeding_TDPLCD-unsonicated-0.01_1',
 'I07':'control_TDPt25-sonicated-seeds_1',
 'I08':'control_TDPt25-sonicated-seeds_1',
 'I09':'control_TDPt25-sonicated-seeds_1',
 'I11':'seeding_TDPt35-sonicated-1_1',
 'I12':'seeding_TDPt35-sonicated-1_1',
 'I13':'seeding_TDPt35-sonicated-1_1',
 'J03':'control_TDPLCD-sonicated-seeds_1',
 'J04':'control_TDPLCD-sonicated-seeds_1',
 'J05':'control_TDPLCD-sonicated-seeds_1',
 'J07':'seeding_TDPt25-sonicated-1_1',
 'J08':'seeding_TDPt25-sonicated-1_1',
 'J09':'seeding_TDPt25-sonicated-1_1',
 'J11':'seeding_TDPt35-sonicated-0.3_1',
 'J12':'seeding_TDPt35-sonicated-0.3_1',
 'J13':'seeding_TDPt35-sonicated-0.3_1',
 'K03':'seeding_TDPLCD-sonicated-1_1',
 'K04':'seeding_TDPLCD-sonicated-1_1',
 'K05':'seeding_TDPLCD-sonicated-1_1',
 'K07':'seeding_TDPt25-sonicated-0.3_1',
 'K08':'seeding_TDPt25-sonicated-0.3_1',
 'K09':'seeding_TDPt25-sonicated-0.3_1',
 'K11':'seeding_TDPt35-sonicated-0.1_1',
 'K12':'seeding_TDPt35-sonicated-0.1_1',
 'K13':'seeding_TDPt35-sonicated-0.1_1',
 'L03':'seeding_TDPLCD-sonicated-0.3_1',
 'L04':'seeding_TDPLCD-sonicated-0.3_1',
 'L05':'seeding_TDPLCD-sonicated-0.3_1',
 'L07':'seeding_TDPt25-sonicated-0.1_1',
 'L08':'seeding_TDPt25-sonicated-0.1_1',
 'L09':'seeding_TDPt25-sonicated-0.1_1',
 'L11':'seeding_TDPt35-sonicated-0.03_1',
 'L12':'seeding_TDPt35-sonicated-0.03_1',
 'L13':'seeding_TDPt35-sonicated-0.03_1',
 'M03':'seeding_TDPLCD-sonicated-0.1_1',
 'M04':'seeding_TDPLCD-sonicated-0.1_1',
 'M05':'seeding_TDPLCD-sonicated-0.1_1',
 'M07':'seeding_TDPt25-sonicated-0.03_1',
 'M08':'seeding_TDPt25-sonicated-0.03_1',
 'M09':'seeding_TDPt25-sonicated-0.03_1',
 'M11':'seeding_TDPt35-sonicated-0.01_1',
 'M12':'seeding_TDPt35-sonicated-0.01_1',
 'M13':'seeding_TDPt35-sonicated-0.01_1',
 'N03':'seeding_TDPLCD-sonicated-0.03_1',
 'N04':'seeding_TDPLCD-sonicated-0.03_1',
 'N05':'seeding_TDPLCD-sonicated-0.03_1',
 'N07':'seeding_TDPt25-sonicated-0.01_1',
 'N08':'seeding_TDPt25-sonicated-0.01_1',
 'N09':'seeding_TDPt25-sonicated-0.01_1',
 'N11':'control_TDPmRUBY-sonicated-seeds_1',
 'N12':'control_TDPmRUBY-sonicated-seeds_1',
 'N13':'control_TDPmRUBY-sonicated-seeds_1',
 'O03':'seeding_TDPLCD-sonicated-0.01_1',
 'O04':'seeding_TDPLCD-sonicated-0.01_1',
 'O05':'seeding_TDPLCD-sonicated-0.01_1',
 'O07':'control_TDPLCD-monmon-1_1',
 'O08':'control_TDPLCD-monmon-1_1',
 'O09':'control_TDPLCD-monmon-1_1',
